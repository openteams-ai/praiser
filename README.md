...
- **Code owner** — Designated reviewer/approver for specific parts of a project — shown scoped to the sub-component owned. _Evidence:_ CODEOWNERS entries or OWNERS reviewers.
